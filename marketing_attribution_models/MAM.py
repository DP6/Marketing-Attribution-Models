...
class DP6tribution:
    def __init__(
        ...
        """
        MAM ( ) is a class inspired on the R Package ‘GameTheoryAllocation’ from Alejandro Saavedra-Nieves and  
        ...
        Parameters:
          ...
          group_channels_by_id_list = [] by default. SUGESTÃO: Empty list by default.
          ...
          verbose = False by default. Internal parameter for printing while 
                    working with MAM (Multi Tocci Attribution) SUGESTÃO: na real não é sugestão haha, mas um lembrete para mudar pra DP6tribution;
    ...
    def attribution_markov(self, transition_to_same_state=False, group_by_channels_models=True):
      ...
      def power_to_infinity(matrix):
          ...
          # No infinito tudo converge para 0 ou 1, por isso usamos np.trunc() SUGESTÃO: At infinity everything converges to 0 or 1, thus we use np.trunc()
